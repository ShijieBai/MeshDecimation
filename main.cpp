...
int main() {
    ...
    std::string input_file = R"(D:\A-work\mesh\MeshDecimation\MeshDecimation\input\tpms-1.stl)";
    std::string out_file = R"(D:\A-work\mesh\MeshDecimation\MeshDecimation\output\3.stl)";
    ...
    OpenMesh::OpenMesh_test(input_file, out_file, target_percent);
